...
1. **Кластер Kubernetes**: Убедитесь, что у вас есть доступ к кластеру Kubernetes
   - Локальная разработка: Docker Desktop, Minikube или Kind
   - Облако: EKS, GKE, AKS и т.д.

2. **kubectl**: Инструмент командной строки Kubernetes, настроенный с доступом к кластеру
